...
<head>
  <meta charset="utf-8" >
  <meta name="description" content="information on MediZen job positions" >
  <meta name="keywords" content="HTML, Jobs, MediZen, employment, information" >
  ...
  <title>MediZen job aplication form</title>
    ...
    <link rel="stylesheet" href="styles/images/jobs.css">
</head>
    <body>
        <header>
        ...
        <section class="job-pos">
            <h3>Digital wellness consultant</h3>
            <h5>H5C7B</h5>
            <p>
